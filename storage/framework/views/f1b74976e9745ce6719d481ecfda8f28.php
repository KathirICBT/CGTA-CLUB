<div class="p-6 bg-gray-100 min-h-screen" x-data="{ showDetailsModal: false, showLogoModal: false }">
    ...
    <!--[if BLOCK]><![endif]--><?php if($isFormVisible): ?>
        <!-- Include Company Form Component -->
        <?php
$__split = function ($name, $params = []) {
    return [$name, $params];
};
[$__name, $__params] = $__split('company-form');

$__html = app('livewire')->mount($__name, $__params, 'lw-2354670534-0', $__slots ?? [], get_defined_vars());
...
?>
            ...
            <table class="table-auto w-full">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $companies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $company): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b">
                            <td class="p-3"><?php echo e($company->id); ?></td>
                            <td class="p-3"><?php echo e($company->companyName); ?></td>
                            <td class="p-3"><?php echo e($company->member->first_name ?? 'N/A'); ?></td>
                            <td class="p-3">
                                <!-- Edit Button -->
                                <button wire:click="edit(<?php echo e($company->id); ?>)"
                                        class="text-yellow-500 hover:text-yellow-700 mx-1">
                                    ✏️
                                </button>
                                <!-- Delete Button -->
                                <button wire:click="delete(<?php echo e($company->id); ?>)"
                                        class="text-red-500 hover:text-red-700 mx-1">
                                    🗑️
                                </button>
                                <!-- View Details -->
                                <button wire:click="showDetails(<?php echo e($company->id); ?>)"
    ...
    <div class="flex min-h-screen items-center justify-center p-4">
        <div class="relative w-full max-w-md transform overflow-hidden rounded-xl bg-white shadow-2xl transition-all">
            ...
            <div class="relative pt-6">
                <div class="flex justify-center">
                    <div class="relative" @click="showLogoModal = true">
                        <img src="<?php echo e($selectedCompany->logoImg 
            ...
            <!-- Company Information -->
            <div class="px-6 py-8">
                <h3 class="mb-6 text-center text-2xl font-bold text-gray-900"><?php echo e($selectedCompany->companyName); ?></h3>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-center space-x-3 text-gray-700">
                        ...
                        <span class="font-medium"><?php echo e($selectedCompany->member->first_name ?? 'N/A'); ?></span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 text-gray-700">
                        ...
                        <span class="font-medium"><?php echo e($selectedCompany->package->package_name ?? 'N/A'); ?></span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 text-gray-700">
                        ...
                        <span class="font-medium"><?php echo e($selectedCompany->email); ?></span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 text-gray-700">
                        ...
                        <span class="font-medium"><?php echo e($selectedCompany->phonenumber); ?></span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 text-gray-700">
                        ...
                        <span class="font-medium"><?php echo e($selectedCompany->address); ?></span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 text-gray-700">
                        ...
                        <span class="font-medium">Joined <?php echo e(\Carbon\Carbon::parse($selectedCompany->joinDate)->format('d/m/Y')); ?></span>
                    </div>
                    ...
                    <div class="flex items-center space-x-3 text-gray-700">
                        ...
                        <span class="font-medium"><?php echo e($selectedCompany->region->region ?? 'N/A'); ?>, <?php echo e($selectedCompany->city); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\Akshino\Client\CGTA\Project\CGTAProject\CGTA-CLUB\resources\views/livewire/company.blade.php ENDPATH**/ ?>