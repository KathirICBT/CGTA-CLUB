...
<div x-data="{ menuOpen: false, activeSubmenu: null }" class="relative z-50">
    <!-- Navigation Links -->
        ...
        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="relative group lg:inline-block">
                ...
                <!--[if BLOCK]><![endif]--><?php if(!empty($link['subLinks'])): ?>
                    <button 
                        type="button" 
                        class="flex items-center justify-between px-3 py-2 text-lg font-medium text-white transition duration-300 hover:text-sky-300 w-full text-left lg:w-auto lg:text-center"
                        ...
                        <svg 
                            ...
                            class="h-5 w-5 ml-2 text-gray-300 group-hover:text-blue-400 transition-transform duration-300"
                            fill="none" 
                            viewBox="0 0 24 24" 
                            stroke="currentColor">
                ...
                <?php else: ?>
                    <a 
                        ...
                        class="block px-3 py-2 text-lg font-medium text-white transition duration-300 hover:text-sky-300 w-full text-left lg:w-auto lg:text-center">
                        <?php echo e($link['name']); ?>
                        ...
                        <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $link['subLinks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subLink): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="py-1">
                                <a 
                                    ...
                                    class="block py-0 px-3 text-gray-600 hover:text-sky-600 hover:bg-gray-100 transition duration-300 rounded-md">
...
<?php /**PATH D:\Akshino\Client\CGTA\Project\CGTAProject\CGTA-CLUB\resources\views/livewire/user-panel/nav/navigation.blade.php ENDPATH**/ ?>