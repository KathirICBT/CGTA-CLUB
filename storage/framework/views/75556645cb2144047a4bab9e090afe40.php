<div class="flex space-x-4 p-4 bg-blue-50 overflow-hidden">
    ...
    <div class="w-1/2 bg-white p-6 rounded shadow-md">
        <h2 class="text-2xl font-semibold text-blue-700 mb-6 flex items-center">
            ...
            <?php echo e($isEditMode ? 'Edit Package' : 'Add Package'); ?>
        ...
        <form wire:submit.prevent="<?php echo e($isEditMode ? 'update' : 'store'); ?>">
            <div class="mb-4">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['package_name'];
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-4">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['package_price'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="mb-4">
                ...
                <!--[if BLOCK]><![endif]--><?php $__errorArgs = ['max_membercount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <span class="text-red-500 text-sm"><?php echo e($message); ?></span> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><!--[if ENDBLOCK]><![endif]-->
            ...
            <div class="space-x-4 mt-4 flex">
                <button type="submit" class="w-full bg-blue-500 text-white py-3 rounded-md hover:bg-blue-600 transition">
                    <?php echo e($isEditMode ? 'Update Package' : 'Add Package'); ?>
            ...
            <table class="w-full border rounded-lg overflow-hidden">
                ...
                <tbody>
                    <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $packages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-b">
                            <td class="p-3"><?php echo e($package->package_name); ?></td>
                            <td class="p-3">$<?php echo e(number_format($package->package_price, 2)); ?></td>
                            <td class="p-3"><?php echo e($package->tax); ?>%</td>
                            <td class="p-3 text-gray-600"><?php echo e(Str::limit($package->description, 50)); ?></td>
                            <td class="p-3"><?php echo e($package->duration); ?> days</td>
                            <td class="p-3"><?php echo e($package->max_membercount); ?></td>
                            <td class="p-3">
                                <button wire:click="edit(<?php echo e($package->id); ?>)" class="text-blue-500 hover:text-blue-700 mx-1">
                                    ✏️
                                </button>
                                <button wire:click="delete(<?php echo e($package->id); ?>)" class="text-red-500 hover:text-red-700 mx-1">
                                    🗑️
                                </button>
                            </td>
                        </tr>
...
<?php /**PATH D:\Akshino\Client\CGTA\Project\CGTAProject\CGTA-CLUB\resources\views/livewire/package.blade.php ENDPATH**/ ?>