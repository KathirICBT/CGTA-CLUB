...
<div x-data="{ menuOpen: false }">
    <header class="padding-x py-8 absolute z-10 w-full">
        <nav class="flex justify-between items-center max-container">
            <!-- Logo -->
            <a href="/">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="Connecting GTA Logo"
...
$__html = app('livewire')->mount($__name, $__params, 'lw-781152611-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-781152611-1', $__slots ?? [], get_defined_vars());
...
<?php /**PATH /home/saai/Documents/Work/OurOWn/github/CGTA-CLUB/resources/views/livewire/user-panel/nav/nav.blade.php ENDPATH**/ ?>