<div class="text-gray-600 dark:text-gray-300 pt-8 bg-white" id="reviews">
    ...
    <div class="max-w-7xl mx-auto px-6 md:px-12 xl:px-6">
        ...
        <div class="md:columns-2 lg:columns-3 gap-8 space-y-8">
            <div
                class="aspect-auto p-8 border border-gray-100 rounded-3xl dark:border-gray-700 shadow-2xl shadow-gray-600/10 dark:shadow-none">
...
<?php /**PATH D:\Akshino\Client\CGTA\Project\CGTAProject\CGTA-CLUB\resources\views/livewire/user-panel/customer-review/cust-review.blade.php ENDPATH**/ ?>