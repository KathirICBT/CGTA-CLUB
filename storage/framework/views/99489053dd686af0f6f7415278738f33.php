    ...
    <div class="w-full mx-auto p-6 ">
        ...
        <div class="rounded-lg shadow-md p-3 -mt-24 bg-white">
            <div class="flex items-center space-x-6 bg-white bg-opacity-30 backdrop-blur-md shadow-xl rounded-2xl p-6">
                <div class="relative">
                    <img src="<?php echo e(asset($photoUrl)); ?>" alt="Profile Photo" class="w-24 h-24 rounded-full">
                    <div
                        class="absolute top-2 right-5 transform translate-x-2 -translate-y-2 h-4 w-4 rounded-full ring-2 ring-white flex justify-center items-center
                                    <?php echo e($status === 'Active' ? 'bg-green-500' : ''); ?>

                                    <?php echo e($status === 'Inactive' ? 'bg-red-500' : ''); ?>

                                    <?php echo e($status === 'Waiting' ? 'bg-yellow-500' : ''); ?>">
                        <div
...
<?php /**PATH D:\Akshino\Client\CGTA\Project\CGTAProject\CGTA-CLUB\resources\views/livewire/pages/member/member-view.blade.php ENDPATH**/ ?>