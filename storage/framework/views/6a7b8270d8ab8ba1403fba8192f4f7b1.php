...
$__html = app('livewire')->mount($__name, $__params, 'lw-95603828-0', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-95603828-1', $__slots ?? [], get_defined_vars());
...
$__html = app('livewire')->mount($__name, $__params, 'lw-95603828-2', $__slots ?? [], get_defined_vars());
...
<?php /**PATH D:\Akshino\Client\CGTA\Project\CGTAProject\CGTA-CLUB\resources\views/livewire/pages/events/event-category-comp/event-category-table-component.blade.php ENDPATH**/ ?>