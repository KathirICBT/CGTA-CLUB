...
{{--</div>--}}
   ...
   <div>
       <div class="md:flex md:items-center md:justify-end bg-white shadow-md md:p-4 -mx-4 sm:-mx-6 md:-mx-8">
               ...
               <div class="inline-block min-w-full py-2 align-middle  bg-white shadow-md">
                   <table class="min-w-full divide-y divide-gray-300">
                       ...
                       <tr>
                           ...
                           @endforeach
                           <th class="py-3.5 pr-4 text-left text-sm font-semibold text-gray-900">Actions</th>
                       </tr>
                       </thead>
