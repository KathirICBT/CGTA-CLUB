...
<div class="isolate bg-white px-6 py-5 sm:py-5 lg:px-8 md:w-full rounded-lg mx-3">
    <form wire:submit.prevent="submitForm" method="POST" class="mx-auto mt-8 sm:mt-8 md:w-full overflow-auto h-[45em] p-4 border rounded-md shadow-md scrollbar-custom">
        <label for="first_name" class="text-xl font-semibold leading-6 text-white border flex justify-center items-start p-3 bg-sky-400">
            MEMBER DETAIL
        </label>
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 mt-5">
            <div class="grid col-span-2 ">
                <label for="first_name" class="block text-md font-semibold leading-6 text-gray-900">
                    Photo
                </label>
            ...
            <div>
                ...
                <div class="mt-2.5">
                    <input type="text" id="first_name" wire:model="first_name" placeholder="Your First Name"
                           class="block w-full border-0 px-3.5 py-3  shadow-sm ring-1 ring-inset ring-gray-300  focus:ring-2 focus:ring-inset  sm:text-md sm:leading-6" />
                    @error('first_name') <span class="text-red-500 text-md">{{ $message }}</span> @enderror
                </div>
            </div>
            <div>
                <label for="last_name" class="block text-md font-semibold leading-6 text-gray-900">
                    Last Name
                </label>
                <div class="mt-2.5">
                    <input type="text" id="last_name" wire:model="last_name" placeholder="Your Last Name"
                           class="block w-full border-0 px-3.5 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300  focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6" />
                    @error('last_name') <span class="text-red-500 text-md">{{ $message }}</span> @enderror
                </div>
            </div>
            <div>
                <label for="email" class="block text-md font-semibold leading-6 text-gray-900">
                    Email
                </label>
                <div class="mt-2.5">
            ...
            <div>
                <label for="phone" class="block text-md font-semibold leading-6 text-gray-900">
                    Phone Number
                </label>
                <div class="mt-2.5">
            ...
            <div>
                <label for="date_of_birth" class="block text-md font-semibold leading-6 text-gray-900">
                    Date of Birth
                </label>
                <div class="mt-2.5">
            ...
            <div>
                <label for="bio" class="block text-md font-semibold leading-6 text-gray-900">
                    Bio
                </label>
                <div class="mt-2.5">
        ...
        <label for="first_name" class="text-xl font-semibold leading-6 text-white border flex justify-center items-start p-3 bg-sky-400 mt-5">
            MEMBERSHIP DETAILS
        </label>
        <div class="grid grid-cols-1 gap-x-8 gap-y-6 sm:grid-cols-2 mt-5">
            <div>
                <label for="status" class="block text-md font-semibold leading-6 text-gray-900">
                    Status
                </label>
                <div class="mt-2.5">
                    <select id="status" wire:model="status"
                            class="block w-full border-0 px-3.5 py-4 text-gray-900 shadow-sm ring-1 ring-inset bg-white ring-gray-300  focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6">
            ...
            <div>
                <label for="membership_level" class="block text-md leading-6 text-gray-900 font-semibold" >
                    Membership Level
                </label>
                <div class="mt-2.5">
            ...
            <div>
                <label for="join_date" class="block text-md font-semibold leading-6 text-gray-900">
                    Joined Date
                </label>
                <div class="mt-2.5">
            ...
            <div>
                <label for="renewal_date" class="block text-md font-semibold leading-6 text-gray-900">
                    Renewal Date
                </label>
                <div class="mt-2.5">
            ...
            @if (!$memberId) <!-- Show password field only when creating a new member -->
                <div>
                    <label for="password" class="block text-md font-semibold leading-6 text-gray-900">
                        Password
                    </label>
                    <div class="mt-2.5">
                        <div class="relative">
                            <input type="{{ $showPassword ? 'text' : 'password' }}" id="password" wire:model="password" placeholder="Your Password"
                                   class="block w-full border-0 px-3.5 py-3 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300  focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-md sm:leading-6" />
                            <button type="button" wire:click="toggleShowPassword" class="absolute inset-y-0 right-0 px-3 py-3">
