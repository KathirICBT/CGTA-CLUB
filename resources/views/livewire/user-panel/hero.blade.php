{{-- <div>
    <section id="home" class="w-full flex xl:flex-row flex-col justify-center 
        ...
        <div class="relative xl:w-2/5 flex flex-col justify-center 
        items-start w-full max-xl:padding-x pt-28">
            <p class="text-xl font-montserrat text-blue-600 mt-14 pl-3">We are a Dynamic Network</p>
            <h1 class=" mt-6 font-palanquin text-8xl max-sm:text-[72px] 
            max-sm:leading-[82px] font-bold">
                <span class="xl:bg-white xl:whitespace-nowrap 
                relative z-10 pr-10">
                    <span class=" text-blue-600 inline-block mt-3 animate-bounce">
                        Connecting
                    </span>
                    Business
                </span>
                ...
                <span class="xl:bg-white xl:whitespace-nowrap 
                relative z-10 pr-10">
                    Communities, and </span>
                Individuals

            </h1>
            <p class=" font-montserrat text-slate-gray 
            text-[23px] leading-8 mt-5 mb-7 sm:max-w-sm">
                Across the Greater Toronto Area
            </p>


            <livewire:user-panel.component.button label="Register Today" iconURL="cgta-register-icon.png"
                iconAlt="CGTA Register Icon" url="/register" color="#4CAF50" />
        ...
        bg-hero bg-cover bg-center">
            <img src="{{ asset('images/banner_01.png') }}" alt="Connecting GTA Banner Image"
...
<section class="h-dvh w-dvw max-h-[80rem] relative">
    <div class="absolute inset-0 z-[1]">
        <img class="h-full w-full object-cover object-center" src="{{ asset('images/bg_02.png') }}" alt="" />
    </div>
    <div class="max-w-[120rem] mx-auto h-full relative z-[2] px-6 md:px-8 lg:px-10">
        <div class="h-full w-full flex flex-col relative space-y-6">
            ...
            {{-- <div class="mt-auto mb-0 text-gray-50 md:pb-36 space-y-6">
                <span class="font-light text-sm text-accent-500">We are a Dynamic Network</span>
                <h1 class="text-3xl md:text-5xl max-w-[30rem] font-medium">
                    Connecting Business
                </h1>
                <p
            ...
            {{-- <div class="relative h-screen text-white">               
                    ...
                    <div class="absolute bottom-10 left-10 max-w-lg bg-blue-900 bg-opacity-80 p-6 rounded-lg shadow-lg">
                        <span class="text-blue-300 font-light text-sm">We are a Dynamic Network</span>
                        <h1 class="text-4xl font-bold leading-tight mt-4">
                        ...
                        <div class="flex gap-4 mt-6">
                            <button class="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 shadow-md">
                                Join Today
                            </button>
                            <button class="px-6 py-2 border border-blue-400 text-blue-300 font-medium rounded-lg hover:bg-blue-700 hover:text-white shadow-md">
                                View Events
                            </button>
                        </div>
                    </div>                
             ...
             <div class="relative h-screen text-white">  
                <div 
                    class="absolute bottom-10 left-10 max-w-lg bg-blue-900 bg-opacity-80 p-6 rounded-lg shadow-lg transform opacity-0 animate-fade-slide-up">
                    <span class="text-blue-300 font-light text-sm">We are a Dynamic Network</span>
                    <h1 class="text-4xl font-bold leading-tight mt-4">
                        Connecting 
                        <span class=" text-blue-200 inline-block mt-3 animate-bounce">
                        Business
                        </span>
                    ...
                    <div class="flex gap-4 mt-6">
                        <button class="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 shadow-md transform hover:scale-105 transition duration-300 ease-in-out">
                            Join Today
                        </button>
                        <button class="px-6 py-2 border border-blue-400 text-blue-300 font-medium rounded-lg hover:bg-blue-700 hover:text-white shadow-md transform hover:scale-105 transition duration-300 ease-in-out">
                            View Events
                        </button>
                    </div>
                </div>
            ...
            <div class="md:absolute md:right-0 md:bottom-32 text-gray-50 my-16">
                <ul class="flex md:flex-col items-center justify-center gap-2">
                    ...
                    <li class="h-6 w-6 block rounded-full bg-accent-400 text-gray-50 p-1">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-full h-full fill-none stroke-current"
